...
let passBoard = document.getElementById("passBoard");
let passClue = document.getElementById("passClue");
let passShow = document.getElementById("passShow");
let passNextP = document.getElementById("passNextP");
let passName = document.getElementById("passName");
let passArrow = document.getElementById("passArrow");
let exitPass = document.getElementById("exitPass");
